...
import { useUserStore } from '@/stores/userStore'; // 导入 store 存储用户登录信息

// 表单数据对象
const userInfo = ref({
  username: '13700032456',
  password: '111111',
})
